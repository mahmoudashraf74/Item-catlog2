...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description=" A famous duck dish from Beijing[1] "
                                 ...
                                 "crisp skin, with authentic versions "
                                 "of the dish serving "
                                 "mostly the skin and little meat, sliced "
                                 "in front of the "
                                 "diners by the cook",
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                     description="A Chinese noodle soup made of "
                                 "stewed or red braised beef, "
                                 "beef broth, vegetables and "
                                 "Chinese noodles.",
...
menuItem2 = MenuItem(user_id=1, name="Chinese Dumplings",
                     description="a common Chinese dumpling which "
                                 "generally consists"
                                 " of minced meat and finely chopped"
                                 " vegetables wrapped into"
                                 " a piece of dough skin. The skin can be "
                                 "either thin and elastic"
                                 " or thicker.",
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake",
                     description="Rich, luscious sponge cake "
                                 ".soaked in sweet milk"
                                 " and topped with vanilla bean "
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     description="Golden fried cauliflower "
                                 ...
                                 " soya,garlic sauce cooked with "
                                 "fresh cilantro, celery, "
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     description="Chicken marinated in yoghurt and "
                                 "seasoned with a spicy"
                                 " mix(chilli, tamarind among others) and "
                                 "slow cooked in "
                                 "a cylindrical clay or metal oven which "
                                 "gets its heat "
